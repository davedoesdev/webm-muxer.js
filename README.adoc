...
(tested on Chrome 93 Linux with `#enable-experimental-web-platform-features`).
...
You can use link:EBML.js[] to make the concatenated WebM data seeekable. See link:demo.js#94[the demo] for an example of how to do this. `EBML.js` was generated
