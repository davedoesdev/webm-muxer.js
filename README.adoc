...
(tested on Chrome 91 Linux with `#enable-experimental-web-platform-features`).
...
. When your application receives a message from one of the Workers running `encoder-worker.js`, send it onto
